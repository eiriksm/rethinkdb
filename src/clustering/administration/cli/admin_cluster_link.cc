...
void admin_cluster_link_t::do_admin_pin_shard(const admin_command_parser_t::command_data_t& data) {
    ...
    if (ns_path[0] == "rdb_namespaces") {
        ...
        if (primary.empty() && secondaries.empty()) {
            list_pinnings(i->second.get_copy(), shard_in, cluster_metadata);
        } else {
...
void admin_cluster_link_t::do_admin_list(const admin_command_parser_t::command_data_t& data) {
    ...
    if (obj_str.empty()) {
        ...
        if (info->path[0] == "datacenters") {
            ...
            list_single_datacenter(obj_id, i->second.get_copy(), cluster_metadata);
            ...
            list_single_database(obj_id, i->second.get_copy(), cluster_metadata);
            ...
            list_single_namespace(obj_id, i->second.get_copy(), cluster_metadata, "rdb");
        } else if (info->path[0] == "dummy_namespaces") {
            ...
            list_single_namespace(obj_id, i->second.get_copy(), cluster_metadata, "dummy");
        } else if (info->path[0] == "memcached_namespaces") {
            cow_ptr_t<namespaces_semilattice_metadata_t<memcached_protocol_t> >::change_t change(&cluster_metadata.memcached_namespaces);
            ...
            list_single_namespace(obj_id, i->second.get_copy(), cluster_metadata, "memcached");
            ...
            list_single_machine(obj_id, i->second.get_copy(), cluster_metadata);
        } else {
